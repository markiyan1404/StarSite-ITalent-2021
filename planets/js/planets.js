...
function getActive_Personajes(){
    ...
    let fist_title_active   = "#slide_title" + LSfist_title_active;
  ...
  $("#slide_title2").addClass("active_slide_title");
 }
};
...
$(".right_arrow").click(function(){
  ...
  $(".more_text_blocks_active").removeClass("more_text_blocks_active");
  ...
  let next_active_slide_title = "#slide_title" + (next_active_slide_num + 1);
  let next_active_slide_text = "#more_text_block" + (next_active_slide_num + 1);
  $(next_active_slide).addClass("active_slide");
  $(next_active_slide_title).addClass("active_slide_title");
  $(next_active_slide_text).addClass("more_text_blocks_active");
...
function activing_big_slide(){
  ...
  let next_active_slide_text = "#more_text_block" + next_active_slide_num_text;
  $(next_active_slide_text).addClass("more_text_blocks_active");

$(".active_slide").addClass("active_slideMore");
$(".btn_cont").css("display", "none");
$(".background_border, .menu, .content_title").fadeOut();
